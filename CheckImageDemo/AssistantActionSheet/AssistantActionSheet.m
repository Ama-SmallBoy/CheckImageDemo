...
@interface AssistantActionSheet ()

/** block回调 */
@property (copy, nonatomic) AssistantActionSheetBlock actionSheetBlock;
/** 背景图片 */
...
@implementation AssistantActionSheet
...
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles handler:(AssistantActionSheetBlock)actionSheetBlock
{
    ...
    if (self)
    {
        ...
        if (otherButtonTitles && [otherButtonTitles count] > 0)
        {
            for (int i = 0; i < otherButtonTitles.count; i++)
            {
                ...
                [button setTitleColor:[UIColor colorWithHexString:@"333333" alpha:1.0] forState:UIControlStateNormal];
        ...
        if (cancelButtonTitle && cancelButtonTitle.length > 0)
        {
            ...
            [cancelButton setTitleColor:[UIColor colorWithHexString:@"666666" alpha:1.0] forState:UIControlStateNormal];
...
+ (instancetype)actionSheetWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles handler:(AssistantActionSheetBlock)actionSheetBlock
{
...
+ (void)showActionSheetWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles handler:(AssistantActionSheetBlock)actionSheetBlock
{
    AssistantActionSheet *lpActionSheet = [self actionSheetWithTitle:title cancelButtonTitle:cancelButtonTitle destructiveButtonTitle:destructiveButtonTitle otherButtonTitles:otherButtonTitles handler:actionSheetBlock];
    [lpActionSheet show];
}
